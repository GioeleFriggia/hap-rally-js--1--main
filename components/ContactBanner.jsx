...
/**
 * Banner contatti / sponsor: invio email via /api/contact (POST)
 * - Valida i campi client-side
 * - Mostra stati: loading, success, error
 * - Honeypot anti-bot: _hp
 */
